		...
		<div class="span12">
			<form class="" onsubmit="return false;">
				...
				<div class="group-form">
					<input type="text" class="input-block-level input-s1 form-control" id="staffing_initialemail" placeholder="Enter Email Address">
				</div>
	...
	<form class="" onsubmit="return false;">
		...
		<div class="row-fluid">
			<div class="span6">
				<div class="group-form">
					...
					<input class="input-block-level input-s1 form-control" type="text" id="staffing_firstname">
				</div>
			</div>
			<div class="span6">
				<div class="group-form">
					...
					<input class="input-block-level input-s1 form-control" type="text" id="staffing_lastname">
				</div>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span6">
				<div class="group-form">
					...
					<input class="input-block-level input-s1 form-control" type="text" id="staffing_email">
				</div>
			</div>
			<div class="span6">
				<div class="group-form">
					...
					<input class="input-block-level input-s1 form-control" type="text" id="staffing_website">
				</div>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span6">
				<div class="group-form">
					...
					<select class="input-block-level input-s1 form-control" id="staffing_country">
						<option value=""></option>									
			...
			<div class="span6">
				<div class="group-form">
					...
					<input class="input-block-level input-s1 form-control" type="text" id="staffing_city">
				</div>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span6">
				<div class="group-form">
					...
					<input class="input-block-level input-s1 form-control" type="password" id="staffing_password">
				</div>
			</div>
			<div class="span6">
				<div class="group-form">
					...
					<input class="input-block-level input-s1 form-control" type="password" id="staffing_password2">
				</div>
			</div>
		</div>
		...
		<div class="row-fluid">	
			...
			<div class="span6 text-right">
				<button type="submit" class="btn btn-primary" id="staffing_btn_2">Next <i class="fa fa-chevron-right"></i></button>
			</div>
		</div>
	</form>
</div>
		...
		<div class="row-fluid">
			<div class="span12">
				<div class="group-form">
					...
					<select class="input-s1 input-block-level form-control" id="staffing_role">
						<option value=""></option>
				...
				<div class="group-form">
					...
					<input class="input-block-level input-s1 form-control" type="text" id="staffing_resumeurl">
				</div>
				<div class="group-form">
					<label>
					...
					<textarea class="input-block-level form-control" rows="3" id="staffing_message"></textarea>
				</div>
				<div class="row-fluid">
				...
				<div class="form-group clearfix">
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-8">
								<input type="text" class="input-s1 input-large form-control" id="staffing_facebook" placeholder="link to your facebook profile">
							</div>
							<div class="col-md-2">
								<span>
									(optional)
				...
				<div class="form-group clearfix">
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-8">
								<input type="text" class="input-s1 input-large form-control" id="staffing_linkedin" placeholder="link to your linkedin profile">
							</div>
							<div class="col-md-2">
								<span>
									(optional)
				...
				<div class="form-group clearfix">
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-8">
								<input type="text" class="input-s1 input-large form-control" id="staffing_github" placeholder="link to your github profile">
							</div>
							<div class="col-md-2">
								<span>
									(optional)
				...
				<div class="form-group clearfix">
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-8">
								<input type="text" class="input-s1 input-large form-control" id="staffing_skype" placeholder="your skype id">
							</div>
							<div class="col-md-2">
								<span>
									(optional)
				...
				<div class="form-group clearfix">
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-8">
								<input type="text" class="input-s1 input-large form-control" id="staffing_yahoo" placeholder="your yahoo id">
							</div>
							<div class="col-md-2">
								<span>
									(optional)
				...
				<div class="form-group clearfix">
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-8">
								<input type="text" class="input-s1 input-large form-control" id="staffing_talk" placeholder="your gtalk id">
							</div>
							<div class="col-md-2">
								<span>
									(optional)
				...
				<div class="form-group clearfix">
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-8">
								<input type="text" class="input-s1 input-large form-control" id="staffing_aol" placeholder="your AOL id">
							</div>
							<div class="col-md-2">
								<span>
									(optional)
				...
				<div class="form-group clearfix">
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-8">
								<input type="text" class="input-s1 input-large form-control" id="staffing_wlive" placeholder="your windows live id">
							</div>
							<div class="col-md-2">
								<span>
									(optional)
