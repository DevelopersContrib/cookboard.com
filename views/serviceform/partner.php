		...
		<div class="span12">
			<form class="" onsubmit="return false;">
				...
				<div class="group-form">
					<input type="text" class="input-block-level input-s1 form-control" id="partner_initialemail" placeholder="Enter Email Address">
				</div>
	...
	<form class="" onsubmit="return false;">
		...
		<div class="row-fluid">
			<div class="span6">
				<div class="group-form">
					...
					<input class="input-block-level input-s1 form-control" type="text" id="partner_firstname">
				</div>
			</div>
			<div class="span6">
				<div class="group-form">
					...
					<input class="input-block-level input-s1 form-control" type="text" id="partner_lastname">
				</div>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span6">
				<div class="group-form">
					...
					<input class="input-block-level input-s1 form-control" type="text" id="partner_email">
				</div>
			</div>
			<div class="span6">
				<div class="group-form">
					...
					<input class="input-block-level input-s1 form-control" type="text" id="partner_website">
				</div>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span6">
				<div class="group-form">
					...
					<select class="input-block-level input-s1 form-control" id="partner_country">
						<option value=""></option>									
			...
			<div class="span6">
				<div class="group-form">
					...
					<input class="input-block-level input-s1 form-control" type="text" id="partner_city">
				</div>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span6">
				<div class="group-form">
					...
					<input class="input-block-level input-s1 form-control" type="password" id="partner_password">
				</div>
			</div>
			<div class="span6">
				<div class="group-form">
					...
					<input class="input-block-level input-s1 form-control" type="password" id="partner_password2">
				</div>
			</div>
		</div>
		...
		<div class="row-fluid">
			...
			<div class="span6  text-right">
				<button type="submit" class="btn btn-primary" id="partner_btn_2">Next <i class="fa fa-chevron-right"></i></button>
			</div>
		</div>
	</form>
</div>
		...
		<div class="row-fluid">
			<div class="span12">
				<div class="group-form">
					...
					<select class="input-s1 input-block-level form-control" id="partner_type">
						<option value=""></option>
				...
				<div class="group-form">
					...
					<textarea class="input-block-level form-control" rows="3" id="partner_message"></textarea>
				</div>
				<div class="row-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
				<div class="group-form">
					...
					<input type="text" class="input-s1 input-block-level form-control" id="partner_company">
				</div>
				<div class="group-form">
					<label>
						Company Description
					...
					<textarea class="input-block-level form-control" rows="3"id="partner_companydescription"></textarea>
				</div>
				<div class="group-form">
					<label>
						Company Image
					...
					<input type="text" class="input-s1 input-block-level form-control" id="partner_companyimage">
				</div>
				<div class="group-form">
					<label>
						Company Link
					...
					<input type="text" class="input-s1 input-block-level form-control" id="partner_companyurl">
				</div>
				<div class="row-fluid">
