...
<div class="col-lg-12">    
    <div class="wrap-addFood-container font-raleways">
        ...
        <div class="row">
            ...
            <?= Html::activeHiddenInput($model, 'latlng')?>
            <div class="col-lg-12">
            ...
            <div class="col-lg-2">
                <?= $form->field($model, 'days_to_prepare',['template'=>'<span class="sr-only">Days to prepare</span>{input}{hint}{error}'])
                    ->textInput(['class'=>'form-control','placeholder'=>'Days to prepare']) ?>
            </div>
            <div class="col-lg-12">
                <h2>Location</h2>
            </div>
            ...
            <?php foreach($model->boardEntryPhoto as $item){
                ...
                <div class="col-lg-3">
					...
					<!--<div class="form-group">
                        <input type="radio" name="featured" value="" <?=$item->seq==1?"checked":""?> />
                    </div>-->
                    <div class="form-group">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <a id="submit_entry" href="javascript:;" data-loading-text="Uploading Image..."  autocomplete="off" class="btn btn-warning btn-block btn-lg">
