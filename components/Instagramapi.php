...
class Instagramapi extends Component {
	 ...
	 */
	protected $instagram_config = array(
		'instagram_client_name' => 'cookboard',
		'instagram_client_id' => 'b0228c6481fd4ea0a067c452484d2c24',
		'instagram_client_secret' => 'ac660167522e4f828345b13e1334eab1',
		'instagram_callback_url' => 'http://cookboard.com/import/instagram',
		'instagram_website' => 'http://cookboard.com',
		'instagram_description' => 'upload your photos to your cookboard',
		'instagram_ssl_verify' => TRUE
	);
    ...
    function instagramLogin() {
    	...
    	return 'https://api.instagram.com/oauth/authorize/?client_id=' . $this->instagram_config['instagram_client_id'] . '&redirect_uri=' . $this->instagram_config['instagram_callback_url'] . '&response_type=code';
    ...
    function __apiCall($url, $post_parameters = FALSE) {
	    ...
	    curl_setopt($curl_session, CURLOPT_SSL_VERIFYPEER, $this->instagram_config['instagram_ssl_verify']);
	...
	function authorize($code)
	{
		...
		return $this->__apiCall($authorization_url, "client_id=" . $this->instagram_config['instagram_client_id'] . "&client_secret=" . $this->instagram_config['instagram_client_secret'] . "&grant_type=authorization_code&redirect_uri=" . $this->instagram_config['instagram_callback_url'] . "&code=" . $code);		
    ...
    function getPopularMedia()
    {
    	...
    	$popular_media_request_url = 'https://api.instagram.com/v1/media/popular?client_id=' .$this->instagram_config['instagram_client_id'];
